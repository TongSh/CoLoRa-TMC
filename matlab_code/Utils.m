...
%             baseline = [baseline, baseline*exp(1i*(0))];
        ...
        % generate chirp with sepecific freq and bandwidth
%         function symb = spec_symbol(code_word,start_freq,bandwidth,down)
...
%                 baseline = conj(baseline);
%             end
%             baseline((1:num_samp)/num_samp*BW > bandwidth) = 0;
%             baseline = repmat(baseline,1,2);
%             clear chirpI chirpQ
%             
%             % Shift for encoding
